...
export const ACHIEVEMENTS: AchievementDefinition[] = [
  ...
  {
    id: 'cards_discovered_1',
    name: 'Decrypted',
    description: 'Recover your first card',
    icon: 'gem',
    category: 'progression',
    targetValue: 1,
    trackingType: 'cards_discovered',
    reward: { type: 'gold', value: 100, description: '+100 gold' },
    tier: 1,
    nextTierId: 'cards_discovered_6',
  },
  {
    id: 'cards_discovered_6',
    name: 'Archivist',
    description: 'Recover 6 cards',
    icon: 'gem',
    category: 'progression',
    targetValue: 6,
    trackingType: 'cards_discovered',
    ...
    tier: 2,
    nextTierId: 'cards_discovered_12',
  },
  {
    id: 'cards_discovered_12',
    name: 'Cryptographer',
    description: 'Recover 12 cards',
    icon: 'gem',
    category: 'progression',
    targetValue: 12,
    trackingType: 'cards_discovered',
    reward: { type: 'gold', value: 750, description: '+750 gold' },
    tier: 3,
    nextTierId: 'cards_discovered_24',
  },
  {
    id: 'cards_discovered_24',
    name: 'Full Archive',
    description: 'Recover all 24 cards',
    icon: 'gem',
    category: 'progression',
    targetValue: 24,
    trackingType: 'cards_discovered',
  ...
  },
  {
    id: 'ship_mods_first',
    name: 'Ace Mechanic',
    description: 'Fully mod one ship in the hangar',
    icon: 'wrench',
    category: 'progression',
    targetValue: 1,
    trackingType: 'ships_fully_modded',
    reward: { type: 'gold', value: 500, description: '+500 gold' },
    tier: 1,
    nextTierId: 'ship_mods_fleet',
  },
  {
    id: 'ship_mods_fleet',
    name: 'Fleet Admiral',
    description: 'Fully mod every ship in the fleet',
    icon: 'wrench',
    category: 'progression',
    targetValue: 11,
    trackingType: 'ships_fully_modded',
