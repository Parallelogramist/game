...
export const TUNING = {
  ...
  bosses: {
    ...
    order: ['horde_king', 'void_wyrm', 'the_machine', 'the_bastion', 'the_legion', 'the_pulsar', 'the_obelisk', 'the_helix', 'the_tessellator', 'the_tremor', 'the_diviner', 'the_eclipse'] as const,
  },
