...
export const WEAPON_SYNERGIES: readonly WeaponSynergy[] = [
  ...
  },
  {
    ...
    weaponB: 'frost_nova',
    name: 'Cold Snap',
    description: 'Frozen foes can\'t flee the spread: +20% damage, 10% faster',
    damageMultiplier: 1.2,
    cooldownMultiplier: 0.9,
  },
  {
  ...
  },
  {
    ...
    weaponB: 'mine',
    name: 'Demolition',
    description: 'Twin ordnance levels the field: +20% damage, 10% faster',
    damageMultiplier: 1.2,
    cooldownMultiplier: 0.9,
  },
  {
    ...
    description: 'The aura wears them down for the scythe to reap: +20% damage, 10% faster',
    damageMultiplier: 1.2,
    cooldownMultiplier: 0.9,
  },
  {
    ...
    weaponB: 'singularity',
    name: 'Orbital Siege',
    description: 'Wells herd the horde into the orbit path: +20% damage, 10% faster',
    damageMultiplier: 1.2,
    cooldownMultiplier: 0.9,
  },
] as const;
