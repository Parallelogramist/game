...
// Mirrors UNLOCKABLE_WEAPONS in Upgrades.ts (the 28 weapons offerable as NEW
...
const UNLOCKABLE_IDS = [
  ...
  'guardian', 'wake', 'pulse', 'mine', 'sweep_beam', 'storm', 'railgun', 'scatter', 'focus', 'grenade', 'reaper', 'flail',
];
